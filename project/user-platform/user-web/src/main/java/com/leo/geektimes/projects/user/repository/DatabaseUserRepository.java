package com.leo.geektimes.projects.user.repository;

import com.leo.geektimes.function.ThrowableFunction;
import com.leo.geektimes.projects.user.domain.User;
import com.leo.geektimes.projects.user.sql.DBConnectionManager;
...
public class DatabaseUserRepository implements UserRepository {
    ...
    public boolean save(User user) {
        if(user == null){
            System.out.println("你输入的参数为空,请检查再试");
            return false;
        }
        String INSERT_USER_DML_SQL =  "INSERT INTO users(name,password,email,phoneNumber) VALUES " +
        ...
        try {
            ...
            int result = statement.executeUpdate(INSERT_USER_DML_SQL);
            if(result>0){
                return true;
            }
